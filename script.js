...
const I18N = {
  en: {
    ...
    "viirs.eyebrow": "Featured application",
    "viirs.title": "Maritime & vessel monitoring with VIIRS",
    "viirs.lead": "We use the VIIRS Day/Night Band and the VIIRS Boat Detection (VBD) product to quantify the night-time activity of cargo ships, anchorages and fleets — turning the glow of vessel lights into operational and environmental indicators.",
    "viirs.note": "Ideal for ports, logistics operators and maritime authorities. Historical time series available since 2012.",
    "viirs.1": "Cargo-ship and vessel detection at night (VIIRS Boat Detection)",
    "viirs.2": "Port and anchorage activity: counts and occupancy over time",
    "viirs.3": "Maritime traffic patterns and approach routes",
    ...
    "contact.opt6": "Maritime / VIIRS vessel monitoring",
